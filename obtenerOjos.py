...
def getEye(times = 1,frameShrink = 0.15, coords = (0,0), counterStart = 0, folder = "eyes"):
    ...
    while counter < counterStart+times:
        ...
        if len(feats) > 0:
            ...
            cv.imwrite(folder + "/" + str(coords[0]) + "." + str(coords[1]) + "." + str(counter) + ".jpg", left_eye)
            counter += 1
            print("Se guardo imagen")

def primeratoma(folder="eyes"):
    ...
    for i, j in coords_list:
        ...
        pyautogui.moveTo(i, j)
        getEye(times=20, coords=(i, j), counterStart=60, folder=folder)

def segundatoma(folder="eyes"):
...
def pruebatoma(folder="eyes"):
    ...
    for i, j in coords_list:
        ...
        input("Press Enter to continue...")
        pyautogui.moveTo(i, j)
        getEye(times=1, coords=(i, j), counterStart=60, folder=folder)
...
###-----------TEST------##
#primeratoma(folder="testeyes")
#segundatoma(folder="testeyes")
#terceratoma(folder="testeyes")
#cuartatoma(folder="testeyes")
#quintatoma(folder="testeyes")
#sextatoma(folder="testeyes")
#septimatoma(folder="testeyes")
#octavatoma(folder="testeyes")
#novenatoma(folder="testeyes")
#decimatoma(folder="testeyes")
#onceavatoma(folder="testeyes")